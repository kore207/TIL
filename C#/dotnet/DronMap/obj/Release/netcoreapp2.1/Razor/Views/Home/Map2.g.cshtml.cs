#pragma checksum "C:\Users\CEO\Desktop\소형드론\source\DronMap\DronMap\Views\Home\Map2.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4217935345803c62735f848d3bcf4e5b86240a08"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4217935345803c62735f848d3bcf4e5b86240a08", @"/Views/Home/Map2.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4f2c7baacc304522a7e9e25ff9fc87a4", async() => {
...
");
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(731, 15136, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1f74ec10412f4934836743e622e2178c", async() => {
                BeginContext(737, 15123, true);
                WriteLiteral(@"
    <style type=""text/css"">
        .buttons {
            position: relative;
    ...
    <script type=""text/javascript"">
        ...
        $(""#addDron"").on(""click"", function (e) {                                    
            ...
            if (markerLayer == null) {
                markerLayer = new vw.ol3.l");
                WriteLiteral(@"ayer.Marker(vmap);
            }
            ...
            {
               ");
                WriteLiteral(@" markerLayer.setZIndex(10); // 이동 경로보다 마커가 위에오도록함 
                vmap.addLayer(markerLayer) //마커를 vmap에 등록                        
            }

            
            //jsCreatRoute(routeMap1);
            //routeMap1.start();            
            moveM(dronNum);
        ...
        var moveM = function (dronN) {            
            var t = setInterval(function () ");
                ...
                //coordinates.push(oldcoor);

                var line_feature = new ol.Feature({
                    geometry:");
                WriteLiteral(@" new ol.geom.LineString(coordinates),
                    id: dronNum
                });
        ...
        var layList = [""lt_c_aisprhc"", ""lt_c_aisctrc"", ""lt_c_aisresc"", ""lt_c_aisdngc"", ""lt_c_aismoac"", ""lt_c_a");
                WriteLiteral(@"iscatc"", ""lt_c_aistmac""];
        ...
        $('#' + layList[2]).change(function () {            
            if ($('#' + layList[2]).is("":checked"")) {                
                var wmslayer = vma");
                WriteLiteral(@"p.addNamedLayer(""비행제한구역"", layList[2]);
                vmap.addLayer(wmslayer);
            } else {
        ...
        $('#' + layList[4]).change(function () {            
            if ($('#' + layList[4]).is("":checked"")) {                
                ...
                vmap.removeLayer(vmap.getLayerBy");
                WriteLiteral(@"Name(""군작전구역""));
            }
        });
        ...
        $(""#position"").on(""click"", function (e) {
            e.preventDefault();                                    
            move(14176994.56431106, 4");
                WriteLiteral(@"354866.236842043, 18);
        });             
