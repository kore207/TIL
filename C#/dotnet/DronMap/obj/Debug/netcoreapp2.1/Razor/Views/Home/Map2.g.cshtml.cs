<<<<<<< HEAD
#pragma checksum "C:\Users\CEO\Desktop\소형드론\source\DronMap\DronMap\Views\Home\Map2.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b14b6f82fed4d1de46915f81501817e1fd417b70"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b14b6f82fed4d1de46915f81501817e1fd417b70", @"/Views/Home/Map2.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "42fc65319d394d14ac9a95929caae22f", async() => {
...
");
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6d59d4d61bc648129673e807af169718", async() => {
                }
                );
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d3efb5f2913b4998967e744e3864524c", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(890, 16816, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "db9a1ed08df24f47b21fd3585c434093", async() => {
                BeginContext(896, 16803, true);
                WriteLiteral(@"
    <style type=""text/css"">
        .buttons {
            position: relative;
    ...
    <script type=""text/javascript"">
        ...
        $(""#addDron"").on(""click"", function (e) {                                    
            ...
            var addPoint = [];
            addPoint.push(ol.proj.transform([vmap.getView().getCenter()[0], vm");
                WriteLiteral(@"ap.getView().getCenter()[1]], ""EPSG:900913"", ""EPSG:4326""));
            ...
            //vmap.removeLayer(vmap.ge");
                WriteLiteral(@"tLayerByName(""마커레이어"")) //vmap.getLayerByName(레이어명)            
          ...
          ");
                WriteLiteral(@"  moveM(dronNum); //가상 전시를 위한 timer             
        ...
        $(""#delDron"").on(""click"", function (e) {
            ...
            routeFeatures.pop();
            vmap.getLayers().getArray().filter(vectorLayer => vectorLayer.get('name') === '경로");
                WriteLiteral(@"레이어' + dronNum).forEach(vectorLayer => vmap.removeLayer(vectorLayer));                                    
        });
        ...
        var moveM = function (dronN) {
            ...
            dronInfoArray[dronNum].interval = setInterval(function () {
                ...
                for (var i = 0; i < dronFeatures.length; i++) {
                    var oldcoor = dronFeatures[i].getGeometry(");
      ...
      ");
                WriteLiteral(@"                  newcoor = [oldcoor[0] - dx, oldcoor[1] - dy];
                    else if (i == 4)
                        newcoor = [oldcoor[0] - dx, oldcoor[1] + dy];
                    else
                        newcoor = [oldcoor[0] + dx, oldcoor[1] - dy];
        ...
        //        var dronFeatures = vmap.getLayerByName(""마커레이어"").getSource().getFeatures(); // 마커레이어를 가져온다.
              ");
                WriteLiteral(@" 
        //        var oldcoor = dronFeatures[dronNum-1].getGeometry().getCoordinates();
        //        var newcoor;
        //        moveRect(300);
        //        if (dronN == 1)
        //            newcoor = [oldcoor[0] + dx, oldcoor[1] + dy];
        ...
        //                var iconStyle = new ol.style.Style({
					   ...
					   //     }))
				    //    });
        //                dronFeatures[dronNum-1].setStyle(iconStyle);
        //            }
        //        }
        //        else if (dronN == 3)
        //            newcoor = [oldcoor[0] - dx, oldcoor[1] - dy];");
        ...
        //        dronFeatures[dronNum-1].getGeometry().setCoordinates(newcoor);
        ...
        $('#'+layList[0]).change(function () {            
            if ($('#' +layList[0]).is("":checked"")) {                
                ...
                vmap.removeLayer(vma");
                WriteLiteral(@"p.getLayerByName(""비행금지구역""));
            }
        });
        ...
        ");
                WriteLiteral(@"        var wmslayer = vmap.addNamedLayer(""위험구역"", layList[3]);
                vmap.addLayer(wmslayer);
            } else {
        ...
        $('#' + layList[5]).change(function () {            
            if ($('#' + layList[5]).is("":checked"")) {                
                ...
                vmap.removeLa");
                WriteLiteral(@"yer(vmap.getLayerByName(""훈련구역""));
            }
        });
        ...
        function move(x, y, z) {
            ...
            //vmap.");
                WriteLiteral(@"getView().setCenter(ol.proj.transform(_center, 'EPSG:4326', ""EPSG:900913""));
...
=======
#pragma checksum "C:\Users\CEO\Desktop\소형드론\source\DronMap\DronMap\Views\Home\Map2.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4373f05462313dfa41af0ae711bf767bcc907aa3"
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4373f05462313dfa41af0ae711bf767bcc907aa3", @"/Views/Home/Map2.cshtml")]
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"17c0d9e796847446abb77a811db1a9ab4131c5a2", @"/Views/_ViewImports.cshtml")]
    public class Views_Home_Map2 : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #line hidden
...
=======
            BeginContext(245, 482, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "59ea27b97d804c279990ee36ffee56e2", async() => {
                BeginContext(251, 469, true);
>>>>>>> ebeb377b7ad28db12337bd22f857160a985eef32
                WriteLiteral(@"
    <meta http-equiv=""Content-Type"" content=""text/html; charset=UTF-8"" />
    <title>Dron map 2</title>
...
=======
            BeginContext(731, 15220, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4b5f14f3110b467b867bdb080669d499", async() => {
                BeginContext(737, 15207, true);
>>>>>>> ebeb377b7ad28db12337bd22f857160a985eef32
                WriteLiteral(@"
    <style type=""text/css"">
        .buttons {
    ...
    <script type=""text/javascript"">
        ...
        $(""#addDron"").on(""click"", function (e) {                                    
          ...
          ");
                WriteLiteral(@"  if (markerLayer == null) {
                markerLayer = new vw.ol3.layer.Marker(vmap);
            }
            ...
            if (vmap.");
                WriteLiteral(@"getLayerByName(""마커레이어"") == null)//하나의 레이어에 추가한다.    
            {
                markerLayer.setZIndex(10); // 이동 경로보다 마커가 위에오도록함 
                vmap.addLayer(markerLayer) //마커를 vmap에 등록                        
            }            
        ...
        var style = new ol.style.Style({
            strok");
                WriteLiteral(@"e: new ol.style.Stroke({
                color: [0, 255, 0, .7], //투명도
                width: 1 //두께
            })
        }); // 스타일 설정
        ...
        var moveM = function (dronN) {            
            var t = setInterval(function () {
                ...
                //    image: new ol.style.Icon(({
    ");
                WriteLiteral(@"            //        anchor: [0.9, 46], //마커 이미지의 절대위치를 변경
                //        anchorXUnits: 'fraction',
                //        anchorYUnits: 'pixels',
                //        src: imgSrc
                //    }))
                ...
                if (dronN == 1)
                 ...
                 ");
                WriteLiteral(@"       dronFeatures[0].setStyle(iconStyle);
                    }
                }
                else if (dronN == 3)
                    newcoor = [oldcoor[0] - dx, oldcoor[1] - dy];
        ...
        $('#'+layList[0]).change(function () {            
            if ($('#' +layList[0]).is("":checked"")) {                
                var wmslayer = vmap.addNamedLayer(""비행금지구역");
                WriteLiteral(@""", layList[0]);
                vmap.addLayer(wmslayer);
            } else {
                vmap.getLayerByName(""비행금지구역"");
        ...
        $('#' + layList[5]).change(function () {            
            if ($('#' + layList[5]).is("":checked"")) {                
                var wmslayer = vmap.addNamedLa");
                WriteLiteral(@"yer(""훈련구역"", layList[5]);
                vmap.addLayer(wmslayer);
            } else {
                vmap.getLayerByName(""훈련구역"");
