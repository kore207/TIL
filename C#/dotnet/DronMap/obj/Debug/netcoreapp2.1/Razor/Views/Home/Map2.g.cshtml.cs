#pragma checksum "C:\Users\CEO\Desktop\소형드론\source\DronMap\DronMap\Views\Home\Map2.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d15a660ea2b6d3c95934920367b53bf2a611a705"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d15a660ea2b6d3c95934920367b53bf2a611a705", @"/Views/Home/Map2.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "816b21288be34b0e890c4b91b8409e89", async() => {
...
");
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "bd4add00b5674c8e960cde2dfac6f002", async() => {
                }
                );
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "47d57095ceac4f28a127b99c6cef7f6e", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(890, 16608, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ea26f3359048473d9577dcd9db32e58e", async() => {
                BeginContext(896, 16595, true);
                WriteLiteral(@"
    <style type=""text/css"">
        .buttons {
            position: relative;
    ...
    <div id=""navi"" style=""height:100%; float:left; width:13% "">
        ...
        <div class=""custom-control custom-checkbox checkbox-xl"" "">
            ...
            <label class=""custom-control-label"" for=""customCheck1"" style=""color");
                WriteLiteral(@":purple""> 위험구역    25kg↑</label><br />
    ...
    <script type=""text/javascript"">
        ...
        vw.ol3.MapOptions = {
            basemapType: vw.");
                WriteLiteral(@"ol3.BasemapType.GRAPHIC
        ...
        var line_feature = new Array(); //이동 경로 그릴 틀
        var vectorSource;
        var vectorLayer;        
        //var mfeaturel = new Array();
        let dronObject =[];
        ...
        $(""#addDron"").on(""click"", function (e) {                                    
            ...
            dronObj");
                WriteLiteral(@"ect.push(new DronInfo(dronNum, ""Dron"" + dronNum, ""익명"", ""010-xxxx-xxxx"", ""YES"", 0));
            ...
            markerLayer.set(""name"", ""마커레이어""); //이것도 null 일떄 너보기
        ...
        ");
                WriteLiteral(@"    dronObject.popInfo = markerLayer.addMarker(vw.ol3.markerOption);// 마커를 레이어에 등록                        
        ...
        $(""#delDron"").on(""click"", function (e) {
            ...
            markerLayer");
                WriteLiteral(@".removeMarker(DronFeatures[dronNum]);
        ...
        var moveM = function (dronN) {
            ...
            dronObject[dronNum].interval = setInterval(function () ");
                WriteLiteral(@"{
                ...
                for (var i = 0; i < dronFeatures.length; i++) {
                    ...
                    //dronInfoArray[i].flyTime = dronInfoArray[i].flyTimeSet(dronInfoArray[i].flyTime);
                    //console.log(dronInfoArray[i].flyTime);

                    var oldcoor = dronFeatures[i].getGeometry().getCoordinates();
                    var newcoor;
                    moveRect(300);
                    if (i == 1)
                        ...
                        //    var iconSt");
                WriteLiteral(@"yle = new ol.style.Style({
                ...
                WriteLiteral(@"PI / 2.0;
                    ...
                    //if (distance % 100 == 0) {                        
            ");
                WriteLiteral(@"            line_feature[i].getGeometry().appendCoordinate(newcoor);                        
                    //}
                }                                                                                                
            }, 100);
        }
        ...
        $('#' + layList[1]).change(function () {            
            if ($('#' + layList[1]).is("":checked"")) {                
               ");
                WriteLiteral(@" var wmslayer = vmap.addNamedLayer(""관제권"", layList[1]);
                vmap.addLayer(wmslayer);
            } else {
        ...
        $('#' + layList[3]).change(function () {
            ...
            if ($('#' + layList[3]).is("":checked"")) {                
                ...
                vmap.removeLayer(v");
                WriteLiteral(@"map.getLayerByName(""위험구역""));
            }
        });
        ...
        $('#' + layList[6]).change(function () {
            if ($('#' + layList[6]).is("":checked"")) {
                var wmslayer = vmap.ad");
                WriteLiteral(@"dNamedLayer(""접근관제구역"", layList[6]);
                vmap.addLayer(wmslayer);
            } else {
